...
public class LineBreakingUtil {
	...
	public static int getEndingIndex(TextHandlerAccessor textHandler,String text, int maxWidth, Style style) {
		Parser parser = getParser();
		LineBreakResult result = new LineBreaker(textHandler, maxWidth, parser).tryBreak(text, 0, style, style);
	...
	public static void wrapLines(TextHandlerAccessor textHandler, StringVisitable stringVisitable, float maxWidth, Style resetStyle, BiConsumer<StringVisitable, Boolean> biConsumer) {
